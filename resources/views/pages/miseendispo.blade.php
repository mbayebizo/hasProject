...
@section('content')
    <section class="sub-header">
        ...
        <ul class="breadcrumb">
            ...
            <li><span class="active">MIse en disposition</span></li>
        </ul>
    </section>
    <section class="services">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h4 class="section-title"><span>01</span>Mise en diposition</h4>
                </div>
                <!-- end col-12 -->
                <div class="col-md-9">
                    <p class="lead">Spécialiste d’acheminement de vos colis, notre service est à la fois pratique et
                        abordable, vous permettant d'expédier en toute sécurité vos colis d'affaires, des cadeaux à votre famille ou aux amis depuis la France vers le Mali (Bamako), Sénégal (Dakar), Côte d'Ivoire (Abidjan).
                        Nous proposons des solutions simples et économiques.</p>
